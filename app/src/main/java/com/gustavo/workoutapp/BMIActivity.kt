...
import com.gustavo.workoutapp.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(supportActionBar !=null){
            ...
            supportActionBar?.title = "Calcule seu IMC"
        }
    ...
    private fun displayBMIResults(bmi:Float){
        ...
        if (bmi.compareTo(15f) <= 0) {
            bmiLabel = "Extremamente Magro"
            bmiDescription = "Oops! Você precisa cuidar do seu corpo! Coma mais!"
        } else if (bmi.compareTo(15f) > 0 && bmi.compareTo(16f) <= 0
        ) {
            bmiLabel = "Muito Magro"
            bmiDescription = "Oops! Você precisa cuidar do seu corpo! Coma mais!"
            ...
            bmiLabel = "Normal"
            bmiDescription = "Parabéns! Você está em forma!"
            ...
            bmiDescription = "Oops! Você precisa cuidar do seu corpo! Exercite-se!"
    ...
    private fun calculateUnits(){
        if(currentVisibleView== METRIC_UNITS_VIEW){
            if(validateMatricUnits()){
                ...
                Toast.makeText(this@BMIActivity,"Por favor , coloque valores corretos",Toast.LENGTH_LONG).show()
            }
        }else{
            if(validateUsUnits()){
